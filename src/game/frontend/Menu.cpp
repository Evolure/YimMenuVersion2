...
namespace YimMenu
{
	...
	{
		ImGuiStyle& style = ImGui::GetStyle();
		style.Colors[ImGuiCol_Text]                 = ImVec4(0.98f, 0.98f, 1.00f, 1.00f);
		style.Colors[ImGuiCol_TextDisabled]         = ImVec4(0.60f, 0.65f, 0.75f, 1.00f);
		style.Colors[ImGuiCol_WindowBg]             = ImVec4(0.05f, 0.07f, 0.14f, 0.97f);
		style.Colors[ImGuiCol_ChildBg]              = ImVec4(0.07f, 0.09f, 0.17f, 0.00f);
		style.Colors[ImGuiCol_PopupBg]              = ImVec4(0.07f, 0.09f, 0.17f, 0.98f);
		style.Colors[ImGuiCol_Border]               = ImVec4(0.82f, 0.12f, 0.20f, 0.45f);
		style.Colors[ImGuiCol_BorderShadow]         = ImVec4(0,0,0,0);
		style.Colors[ImGuiCol_FrameBg]              = ImVec4(0.10f, 0.14f, 0.24f, 0.90f);
		style.Colors[ImGuiCol_FrameBgHovered]       = ImVec4(0.15f, 0.21f, 0.35f, 1.00f);
		style.Colors[ImGuiCol_FrameBgActive]        = ImVec4(0.18f, 0.25f, 0.42f, 1.00f);
		style.Colors[ImGuiCol_TitleBg]              = ImVec4(0.06f, 0.08f, 0.16f, 1.00f);
		style.Colors[ImGuiCol_TitleBgActive]        = ImVec4(0.82f, 0.12f, 0.20f, 1.00f);
		style.Colors[ImGuiCol_TitleBgCollapsed]     = ImVec4(0.04f, 0.06f, 0.10f, 0.80f);
		style.Colors[ImGuiCol_MenuBarBg]            = ImVec4(0.08f, 0.10f, 0.18f, 1.00f);
		style.Colors[ImGuiCol_ScrollbarBg]          = ImVec4(0.04f,0.05f,0.09f,1.0f);
        style.Colors[ImGuiCol_ScrollbarGrab]        = ImVec4(0.82f,0.12f,0.20f,1.0f);
        style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.93f,0.20f,0.28f,1.0f);
        style.Colors[ImGuiCol_ScrollbarGrabActive]  = ImVec4(1.00f,0.28f,0.35f,1.0f);
		style.Colors[ImGuiCol_CheckMark]            = ImVec4(1.00f,1.00f,1.00f,1.00f);
        style.Colors[ImGuiCol_SliderGrab]           = ImVec4(0.82f,0.12f,0.20f,1.00f);
        style.Colors[ImGuiCol_SliderGrabActive]     = ImVec4(0.97f,0.24f,0.30f,1.00f);
	    style.Colors[ImGuiCol_Button]               = ImVec4(0.82f,0.12f,0.20f,0.75f);
        style.Colors[ImGuiCol_ButtonHovered]        = ImVec4(0.92f,0.20f,0.28f,1.00f);
        style.Colors[ImGuiCol_ButtonActive]         = ImVec4(1.00f,0.28f,0.35f,1.00f);
		style.Colors[ImGuiCol_Header]               = ImVec4(0.13f,0.18f,0.33f,0.90f);
        style.Colors[ImGuiCol_HeaderHovered]        = ImVec4(0.20f,0.27f,0.48f,1.00f);
        style.Colors[ImGuiCol_HeaderActive]         = ImVec4(0.82f,0.12f,0.20f,1.00f);
		style.Colors[ImGuiCol_Separator]            = ImVec4(0.82f,0.12f,0.20f,0.55f);
        style.Colors[ImGuiCol_SeparatorHovered]     = ImVec4(0.93f,0.20f,0.28f,1.00f);
        style.Colors[ImGuiCol_SeparatorActive]      = ImVec4(1.00f,0.28f,0.35f,1.00f);
		style.Colors[ImGuiCol_ResizeGrip]           = ImVec4(1.00f,1.00f,1.00f,0.20f);
        style.Colors[ImGuiCol_ResizeGripHovered]    = ImVec4(1.00f,1.00f,1.00f,0.60f);
        style.Colors[ImGuiCol_ResizeGripActive]     = ImVec4(1.00f,1.00f,1.00f,0.90f);
		style.Colors[ImGuiCol_Tab]                  = ImVec4(0.08f,0.11f,0.22f,1.00f);
        style.Colors[ImGuiCol_TabHovered]           = ImVec4(0.82f,0.12f,0.20f,1.00f);
        style.Colors[ImGuiCol_TabActive]            = ImVec4(0.18f,0.25f,0.45f,1.00f);
        style.Colors[ImGuiCol_TabUnfocused]         = ImVec4(0.06f,0.08f,0.16f,1.00f);
        style.Colors[ImGuiCol_TabUnfocusedActive]   = ImVec4(0.10f,0.14f,0.25f,1.00f);
		style.Colors[ImGuiCol_PlotLines]            = ImVec4(1.00f,1.00f,1.00f,1.00f);
        style.Colors[ImGuiCol_PlotHistogram]        = ImVec4(0.82f,0.12f,0.20f,1.00f);
        style.Colors[ImGuiCol_TextSelectedBg]       = ImVec4(0.82f,0.12f,0.20f,0.35f);
        style.Colors[ImGuiCol_DragDropTarget]       = ImVec4(1.00f,1.00f,1.00f,1.00f);
        style.Colors[ImGuiCol_NavHighlight]         = ImVec4(0.82f,0.12f,0.20f,1.00f);
